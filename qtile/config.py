...
keys = [
        ...
        ### Control the brightness from keyboard
        ...
        Key([], "XF86AudioPlay",
            ...
            desc='Play/pause songs/videos'
            ),
        Key([], "XF86AudioStop",
            lazy.spawn("playerctl stop"),
            desc='Stops audio play'
            ),
        Key([], "XF86AudioNext",
        ...
        Key([], "XF86AudioPrev",
            ...
            desc='Reset/skip to the previous song'
            ),
        ### Rofi menu
        Key([mod], "m",
        ...
        #Key([mod, "shift"], "m",
        #    lazy.spawn("rofi -show -config ~/.config/rofi/themes/dt-dmenu.rasi -display-drun \"Run: \" -drun-display-format \"{name}\""),
        #    desc='Select active windows'
        #),
        Key([mod], "Tab",
            lazy.next_layout(),
...
colors = [["#282c34", "#282c34"], # panel background || default color 282c34 
          ...
          ["#f37c21", "#f37c21"], # temp threshold
          ["#342f2b", "#342f2b"], # black pos 8s
          ["#000000", "#000000"], # real black 9
          ["#ffffff", "#ffffff"], # full white 10
          ["#f5ee0d", "#f5ee0d"], # yellow 11
          ["#0550e6", "#0550e6"], # electric blue 12
          ["#e605dc", "#e605dc"], # pink 13
          ["#f10d67", "#f10d67"], # light red 14
          ["#33d117", "#33d117"], # green 15
          ["#00a6ff", "#00a6ff"], # light blue 16 for bluetooth
          ["#6d6dce", "#6d6dce"], # not to dark blue 17
          ] 

##### Def functions for bar
#def bluetooth():
#    return (
#        subprocess.check_output(["./config/qtile/system-bluetooth-bluetoothctl,sh"]).decode("utf-8").strip()
#    )
#
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=1.0, size=27, background="#666666")),
